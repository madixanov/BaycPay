        ...
        <div className="main-container">
            <div className="welcoming-content">
                ...
                <div className="hero-div" >
                    <p data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">Ваш мост между бизнесом и миром финансовых решений</p>
                    <img src={hero} alt="Hero Image" loading="eager"  data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000"/>
                    <div className="div" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <span>private limited company</span>
                    </div>
                </div>
                <div className="welcoming-contact-us-container" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
